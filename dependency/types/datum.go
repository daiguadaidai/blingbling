...
import (
	...
	"github.com/daiguadaidai/blingbling/dependency/sessionctx/stmtctx"
	"github.com/daiguadaidai/blingbling/dependency/terror"
	"github.com/daiguadaidai/blingbling/dependency/types/json"
	"github.com/daiguadaidai/blingbling/dependency/util/charset"
	"github.com/daiguadaidai/blingbling/dependency/util/hack"
)
		...
		if !dec.IsZero() && prec-frac > flen-decimal {
			...
			if !dec.IsZero() && frac > decimal && dec.Compare(&old) != 0 {
				if sc.InInsertStmt || sc.InUpdateOrDeleteStmt {
					// fix https://github.com/daiguadaidai/blingbling/dependency/issues/3895
					// fix https://github.com/daiguadaidai/blingbling/dependency/issues/5532
